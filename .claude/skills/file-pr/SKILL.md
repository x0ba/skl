...
Before filing, check whether a PR for this branch already exists. Review the diff locally against 'origin/main' to make sure its contents match the 'origin/main goal.
...
GOOD 
> ✅ My "new worktree" default was ignored when størting new threads on existing worktrees. Super unintuitive. Now your preferences always apply.

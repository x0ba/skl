#!/usr/bin/env bash
# Atuin-style curl installer for the skl CLI.
#
...
# Swap SKL_DOWNLOAD_BASE to https://setup.skl.sh later (same asset names).

set -euo pipefail

# One constant for the download origin (release assets + this script).
